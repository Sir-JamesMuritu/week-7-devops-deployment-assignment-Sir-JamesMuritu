    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-classic-bg-50 via-accent-50 to-primary-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-10">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-8 text-4xl font-extrabold text-primary-900 tracking-tight">Welcome back</h2>
          <p className="mt-3 text-base text-gray-600">Sign in to your library account</p>
        </div>
        ...
        <div className="card">
          <form className="space-y-7" onSubmit={handleSubmit} noValidate>
            ...
            {/* Demo Accounts */}
            <div className="bg-accent-50 rounded-lg p-4 mt-2 border border-accent-100">
              <p className="text-sm font-semibold text-primary-900 mb-2">Demo Accounts:</p>
        ...
        {/* Footer text */}
        <div className="text-center">
          <p className="text-xs text-gray-400">Library Management System © 2025</p>
        </div>
      </div>
    </div>
  );
